  ...
  const columns: TableColumn<HarvestingUploadData>[] = useMemo(
    () => [
      ...
      { name: 'Field Code', selector: r => r.fieldcode || '-', sortable: true, width: '110px' },
      {
        ...
        selector: r => {
          try {
            return r.receptiondate ? new Date(r.receptiondate).toLocaleDateString(localeTag) : '-';
          } catch {
            return r.receptiondate || '-';
          }
        },
      },
      {
        ...
        selector: r => {
          try {
            return r.harvestdate ? new Date(r.harvestdate).toLocaleDateString(localeTag) : '-';
          } catch {
      ...
      {
        name: 'Bunch',
        selector: r => (Number(r.bunch) || 0).toLocaleString(localeTag),
        sortable: true,
        width: '100px',
      },
      {
        name: 'Estate Weight (kg)',
        selector: r => (Number(r.bunch_estateweight) || 0).toLocaleString(localeTag),
        sortable: true,
        width: '140px',
      },
      {
        name: 'Mill Weight Bruto',
        selector: r => (Number(r.mill_weight_bruto) || 0).toLocaleString(localeTag),
        sortable: true,
        width: '140px',
      },
      {
        name: 'Mill Weight Netto',
        selector: r => (Number(r.mill_weight_netto) || 0).toLocaleString(localeTag),
        sortable: true,
        width: '140px',
      },
