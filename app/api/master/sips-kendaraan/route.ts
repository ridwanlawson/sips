...
export async function GET(req: NextRequest) {
  ...
  // Ensure users only access records within their authorized organizational units (FCBA/Afdeling).
  ...
  if (!upstream.ok) {
    ...
    console.error('[API_MASTER_KENDARAAN_GET_ERROR]', { status: upstream.status, data });
