...
export const Theme = () => {
  ...
  const handleThemeChange = (newTheme: "light" | "dark" | "retro" | "cyberpunk" | "valentine" | "aqua") => {
        ...
        {themes.map((tItem) => (
          <li key={tItem.value}>
            <button
              ...
              className={theme === tItem.value ? "active flex items-center justify-between" : "flex items-center justify-between"}
